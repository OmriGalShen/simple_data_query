...
public class LessThenOperator extends CompareOperator<Integer> {
    public LessThenOperator(CompareProperty property, Integer value) {
        super(Command.LESS_THAN, property, value);
    }
