...
public class AndOperator extends BooleanOperator {
    ...
    public AndOperator(Operator firstOperator, Operator secondOperator) {
        super(Command.AND );
    ...
    public HashSet<String> performOperator(HashSet<String> keys) {
        return DBUtility.intersection(firstOperator.performOperator(keys), secondOperator.performOperator(keys));
    }
}
